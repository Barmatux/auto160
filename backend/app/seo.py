...
STATIC_SEO: dict[str, tuple[str, str]] = {
    ...
    "/listings": (
        "Лента объявлений авто под льготный утильсбор (до 160 л.с.) в Беларуси — Auto160",
...
def listings_feed_seo_meta(
    *,
    ...
    return SeoMeta(
        ...
        h1="Лента объявлений авто под льготный утильсбор (до 160 л.с.)",
        intro=(
            "Актуальные объявления автомобилей до 160 л.с. в Беларуси: фильтруйте по марке, "
            "городу и требуемым параметрам."
        ),
    )
